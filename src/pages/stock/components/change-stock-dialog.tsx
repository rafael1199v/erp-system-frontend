import { ProductWithWarehouseTableRow } from "../columns";
...
import { UpdateStockForm, UpdateStockFormErrors } from "@/types/forms/update-stock-form";
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <form >
            <DialogTrigger asChild>
              <Button variant="outline" className="cursor-pointer">Editar stock</Button>
            </DialogTrigger>
            <DialogContent className="sm:max-w-sm">
              <DialogHeader>
                ...
                <DialogDescription>
                  ...
                  Cualquier cambio se registrará como un nuevo movimiento para
                  facilitar el seguimiento del producto.
                </DialogDescription>
              </DialogHeader>
              <FieldGroup>
                <Field>
                  ...
                  {updateStockFormErrors.stockError && (
                    <FieldError>
                        {updateStockFormErrors.stockError}
                    </FieldError>
                  )}
                ...
                <Field>
                  ...
                  {updateStockFormErrors.reasonError && (
                    <FieldError>
                        { updateStockFormErrors.reasonError }
                    </FieldError>
                  )}
